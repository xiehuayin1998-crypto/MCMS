...
export default function SafetyUploadDialog({
  open,
  onOpenChange,
  onSuccess,
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const uploadResult = await cloudInstance.uploadFile({
        cloudPath: `safety_environment_system/${Date.now()}_${file.name}`,
        filePath: file
      });
      clearInterval(progressInterval);
      ...
      <div className="space-y-4 py-4">
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
            ...
            <input type="file" accept=".pdf" onChange={handleFileChange} className="hidden" id="safety-pdf-upload" />
            <label htmlFor="safety-pdf-upload" className="cursor-pointer text-sm text-blue-600 hover:text-blue-800">
              点击选择PDF文件
            </label>
